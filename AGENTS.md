...
**Where the queue stands:** piece 8 (the §15/§16 acceptance matrix) is the last
piece, and `docs/FUSION_STATUS.md` §1/§3/§7 record it. There is no pending piece after it; a later
