...
return function(R)
    ...
    local unsupported_names = {
        ...
        "layer_sequence_destroy", "matrix_set", "matrix_get",
        ...
        "vertex_submit", "buffer_create", "buffer_write", "buffer_read", "surface_create",
    ...
    local source_unsupported = {
        ...
        "audio_delete", "audio_exists", "audio_falloff_set_model",
        "audio_get_name", "audio_listener_orientation", "audio_listener_position", "audio_master_gain",
        "audio_play_sound_at", "audio_sound_length", "buffer_delete", "buffer_poke", "buffer_seek", "buffer_tell", "camera_get_proj_mat", "camera_get_view_angle",
        ...
        "camera_get_view_width", "camera_get_view_x", "camera_get_view_y", "camera_set_proj_mat", "camera_set_view_mat",
        -- geometry, drawing, GPU and data structures
        "collision_ellipse", "draw_light_define_ambient",
        "draw_light_define_direction", "draw_light_define_point", "draw_light_enable", "draw_set_lighting", "ds_grid_read", "ds_grid_write",
        ...
        "layer_tile_xscale",
        "layer_tile_y",
        "layer_tile_yscale", "matrix_build", "matrix_build_projection_perspective_fov",
        ...
        "view_get_yport", "view_set_hport", "view_set_surface_id", "view_set_visible", "view_set_wport",
